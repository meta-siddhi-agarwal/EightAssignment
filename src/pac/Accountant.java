...
// Class Accountant which is a sub class of employee class
public class Accountant extends Employee {
	...
	// denotes name of the employee
	String name;

	// acts as uniq. identifier for employees across departments
	int empId;

	// dept. in which an employee is part of
	 ...
	 */
	public Accountant(int empId, double basicPay, String name) {
		this.empId = empId;
