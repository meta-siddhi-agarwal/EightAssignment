...
//Class OfficeAdministrator which is a sub class of employee class
public class OfficeAdministrator extends Employee{
     ...
     */
    public OfficeAdministrator(int empId,double basicPay, String name) {
        this.empId=empId;
